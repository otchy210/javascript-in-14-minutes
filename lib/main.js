...
function checkStep1(str) {
  if (str == 'Hello World!') {
    ...
    return console.log('気をつけて！JavaScript では大文字と小文字を区別します。全ての文字の大文字と小文字が正しいかどうかを確認しましょう。');
  }
...
function checkStep19(str) {
  ...
  console.log('"my_things" という名前の配列を作って、インデックスが 1 の値を選んで下さい。');
}
...
function checkStep21(str) {
  ...
  console.log('"my_things" という名前の配列を作って、"LOVE" という文字列を追加して下さい。');
}
...
function checkStep22(str) {
  ...
  console.log('"my_things" という名前の配列を作って、"ボタン" という文字列を追加して下さい。');
}
...
function checkStep23(str) {
  ...
  console.log('"my_things" という名前の配列を作って、"includes()" というメソッドを呼び出して下さい。');
}
...
function checkStep28(str) {
  if (window.innerWidth > 2000 && str.startsWith('大きな画面！') || window.innerWidth < 600 && str.startsWith('たぶんスマホ')) {
    return showStep(29);
  } else if (str.startsWith('ちょうどいいサイズ')) {
    return showStep(29);
  }
...
function checkArrayLoop(str, nextStep) {
  ...
  console.log('"my_things" という名前の配列を作って、それをループして下さい。');
}
...
function checkStep36(str) {
  if (!state.desktop) {
    ...
    return console.log('"greet" という名前の関数を作って下さい。');
  } else if (str.startsWith('やあ、アレックス')) {
    return showStep(37);
  }
  console.log('"greet" という名前の関数を作って、 \'アレックス\'というパラメータで呼び出して下さい。');
}
